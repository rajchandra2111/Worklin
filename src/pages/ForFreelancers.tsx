...
export function ForFreelancers() {
  ...
  return (
    <div className="py-20 px-6 max-w-[1200px] mx-auto text-center min-h-[60vh] flex flex-col justify-center items-center">
      ...
      <p className="text-lg text-text-secondary mb-10 max-w-[600px] mx-auto">Join thousands of businesses hiring on Worklin. Low fees, guaranteed payments, and a global talent pool.</p>
