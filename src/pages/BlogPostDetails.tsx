...
export function BlogPostDetails() {
  ...
  const handleToggleLike = async () => {
    if (!user) {
      openAuthModal('login', role || 'client');
      return;
    }
    if (!post) return;
    ...
    <div className="bg-background min-h-screen pb-24">
      ...
      <div className="h-[40vh] min-h-[300px] max-h-[500px] w-full relative">
        ...
        <div className="absolute top-6 left-6 z-20">
          <Link to="/blog" className="flex items-center gap-2 text-white bg-black/30 hover:bg-black/50 px-4 py-2 rounded-full backdrop-blur-sm transition-colors text-sm font-medium">
