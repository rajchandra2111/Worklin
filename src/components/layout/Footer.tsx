    ...
    <footer className="bg-primary text-white/60 pt-12 pb-7 px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between md:items-center text-sm gap-4">
          <span>© 2025 <span className="font-tenor font-semibold tracking-tight text-white">Worklin_</span> · <Link to="/" className="text-white/40 hover:text-white transition-colors ml-3">Home</Link></span>
